...
public class Software extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtdescripcion.setForeground(new java.awt.Color(153, 0, 204));
        txtdescripcion.setToolTipText("");
        txtdescripcion.setCaretColor(new java.awt.Color(102, 0, 204));

        txtstock.setFont(new java.awt.Font("Yu Gothic UI", 1, 14)); // NOI18N
        txtstock.setForeground(new java.awt.Color(153, 0, 204));
        txtstock.setToolTipText("");
        txtstock.setCaretColor(new java.awt.Color(102, 0, 204));

        txtprecio.setFont(new java.awt.Font("Yu Gothic UI", 1, 14)); // NOI18N
        txtprecio.setForeground(new java.awt.Color(153, 0, 204));
        txtprecio.setToolTipText("");
        txtprecio.setCaretColor(new java.awt.Color(102, 0, 204));
